...
{
	/// <summary>Classe abstrata que, quando implementada, anima um valor de <see cref="T:System.Windows.Vector" />.</summary>
	// Token: 0x02000566 RID: 1382
	public abstract class VectorAnimationBase : AnimationTimeline
	{
		/// <summary>Cria um clone modificável desse <see cref="T:System.Windows.Media.Animation.VectorAnimationBase" />, fazendo cópias em profundidade dos valores do objeto. Ao copiar as propriedades de dependência, esse método copia associações de dados e referências de recurso (mas eles não podem mais resolver), mas não animações ou seus valores atuais.</summary>
		/// <returns>Um clone modificável do objeto atual. A propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> do objeto clonado será <see langword="false" />, mesmo se a propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> da origem tiver sido <see langword="true." /></returns>
		// Token: 0x0600401F RID: 16415 RVA: 0x000FBA8C File Offset: 0x000FAE8C
		...
		// Token: 0x06004020 RID: 16416 RVA: 0x000FBAA4 File Offset: 0x000FAEA4
		public sealed override object GetCurrentValue(object defaultOriginValue, object defaultDestinationValue, AnimationClock animationClock)
		{
			...
			return this.GetCurrentValue((Vector)defaultOriginValue, (Vector)defaultDestinationValue, animationClock);
		}
		...
		// (get) Token: 0x06004021 RID: 16417 RVA: 0x000FBAE8 File Offset: 0x000FAEE8
		...
		// Token: 0x06004022 RID: 16418 RVA: 0x000FBB08 File Offset: 0x000FAF08
