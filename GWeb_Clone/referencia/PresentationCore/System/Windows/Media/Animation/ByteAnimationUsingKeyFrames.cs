...
{
	/// <summary>Anima o valor de uma propriedade <see cref="T:System.Byte" /> junto com um conjunto de <see cref="P:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.KeyFrames" />.</summary>
	// Token: 0x020004B4 RID: 1204
	[ContentProperty("KeyFrames")]
	public class ByteAnimationUsingKeyFrames : ByteAnimationBase, IKeyFrameAnimation, IAddChild
	{
		/// <summary>Inicializa uma nova instância da classe <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />.</summary>
		// Token: 0x0600360A RID: 13834 RVA: 0x000D7980 File Offset: 0x000D6D80
		public ByteAnimationUsingKeyFrames()
		{
			this._areKeyTimesValid = true;
		}

		/// <summary>Cria um clone modificável desse <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />, fazendo cópias em profundidade dos valores do objeto. Ao copiar as propriedades de dependência, esse método copia associações de dados e referências de recurso (mas eles não podem mais resolver), mas não animações ou seus valores atuais.</summary>
		/// <returns>Um clone modificável do objeto atual. A propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> do objeto clonado será <see langword="false" />, mesmo se a propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> da origem tiver sido <see langword="true." /></returns>
		// Token: 0x0600360B RID: 13835 RVA: 0x000D799C File Offset: 0x000D6D9C
		...
		/// <returns>Um clone modificável do objeto atual. A propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> do objeto clonado será <see langword="false" />, mesmo se a propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> da origem tiver sido <see langword="true" />.</returns>
		// Token: 0x0600360C RID: 13836 RVA: 0x000D79B4 File Offset: 0x000D6DB4
		public new ByteAnimationUsingKeyFrames CloneCurrentValue()
		{
			return (ByteAnimationUsingKeyFrames)base.CloneCurrentValue();
		}

		/// <summary>Faz com que esta instância do objeto <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> não modificável ou determina se ela pode se tornar não modificável.</summary>
		...
		// Token: 0x0600360D RID: 13837 RVA: 0x000D79CC File Offset: 0x000D6DCC
		...
		/// <summary>Chamado quando o objeto <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> atual é modificado.</summary>
		// Token: 0x0600360E RID: 13838 RVA: 0x000D7A04 File Offset: 0x000D6E04
		...
		/// <summary>Cria uma nova instância de <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />.</summary>
		/// <returns>Uma nova instância de <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />.</returns>
		// Token: 0x0600360F RID: 13839 RVA: 0x000D7A20 File Offset: 0x000D6E20
		protected override Freezable CreateInstanceCore()
		{
			return new ByteAnimationUsingKeyFrames();
		}

		/// <summary>Torna essa instância uma cópia profunda do <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> especificado. Ao copiar as propriedades de dependência, esse método copia associações de dados e referências de recurso (mas eles não podem mais resolver), mas não animações ou seus valores atuais.</summary>
		/// <param name="sourceFreezable">O <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> a ser clonado.</param>
		// Token: 0x06003610 RID: 13840 RVA: 0x000D7A34 File Offset: 0x000D6E34
		...
		/// <summary>Torna essa instância uma cópia profunda modificável do <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> especificado usando os valores de propriedade atuais. Referências a recursos, vinculações de dados e animações não são copiadas, mas seus valores atuais são.</summary>
		/// <param name="sourceFreezable">O <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> a ser clonado.</param>
		// Token: 0x06003611 RID: 13841 RVA: 0x000D7A58 File Offset: 0x000D6E58
		...
		/// <summary>Torna essa instância um clone do objeto <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> especificado.</summary>
		...
		// Token: 0x06003612 RID: 13842 RVA: 0x000D7A7C File Offset: 0x000D6E7C
		...
		/// <summary>Torna essa instância um clone congelado do <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> especificado. Referências a recursos, vinculações de dados e animações não são copiadas, mas seus valores atuais são.</summary>
		/// <param name="source">O <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> a ser copiado e congelado.</param>
		// Token: 0x06003613 RID: 13843 RVA: 0x000D7AA0 File Offset: 0x000D6EA0
		...
		// Token: 0x06003614 RID: 13844 RVA: 0x000D7AC4 File Offset: 0x000D6EC4
		private void CopyCommon(ByteAnimationUsingKeyFrames sourceAnimation, bool isCurrentValueClone)
		{
			...
			if (sourceAnimation._keyFrames != null)
			{
				...
				{
					this._keyFrames = (ByteKeyFrameCollection)sourceAnimation._keyFrames.CloneCurrentValue();
				}
				else
				{
		...
		// Token: 0x06003615 RID: 13845 RVA: 0x000D7B44 File Offset: 0x000D6F44
		...
		/// <summary>Adiciona um <see cref="T:System.Windows.Media.Animation.ByteKeyFrame" /> filho a este <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />.</summary>
		/// <param name="child">O objeto a ser adicionado como filho deste <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />.</param>
		/// <exception cref="T:System.ArgumentException">O parâmetro <paramref name="child" /> não é um <see cref="T:System.Windows.Media.Animation.ByteKeyFrame" />.</exception>
		// Token: 0x06003616 RID: 13846 RVA: 0x000D7B74 File Offset: 0x000D6F74
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		protected virtual void AddChild(object child)
		{
			ByteKeyFrame byteKeyFrame = child as ByteKeyFrame;
			if (byteKeyFrame != null)
			{
				this.KeyFrames.Add(byteKeyFrame);
				return;
			}
		...
		// Token: 0x06003617 RID: 13847 RVA: 0x000D7BB0 File Offset: 0x000D6FB0
		...
		/// <summary>Adiciona uma cadeia de caracteres de texto como um filho deste <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />.</summary>
		/// <param name="childText">O texto adicionado ao <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />.</param>
		/// <exception cref="T:System.InvalidOperationException">Um <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> não aceita texto como um filho, portanto, esse método gerará esta exceção, a menos que uma classe derivada tenha substituído esse comportamento, o que permite que o texto seja adicionado.</exception>
		// Token: 0x06003618 RID: 13848 RVA: 0x000D7BD4 File Offset: 0x000D6FD4
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		...
		/// <summary>Calcula um valor que representa o valor atual da propriedade que está sendo animada, conforme determinado por esta instância do <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" />.</summary>
		...
		// Token: 0x06003619 RID: 13849 RVA: 0x000D7BF0 File Offset: 0x000D6FF0
		protected sealed override byte GetCurrentValueCore(byte defaultOriginValue, byte defaultDestinationValue, AnimationClock animationClock)
		{
			...
			if (i == num)
			{
				b = this.GetResolvedKeyFrameValue(num2);
			}
			else if (value == this._sortedResolvedKeyFrames[i]._resolvedKeyTime)
			{
				b = this.GetResolvedKeyFrameValue(i);
			}
			else
			{
				byte baseValue;
				...
				if (i == 0)
				{
					if (this.IsAdditive)
					{
						baseValue = AnimatedTypeHelpers.GetZeroValueByte(defaultOriginValue);
					}
					else
					{
				...
				b = this.GetResolvedKeyFrame(i).InterpolateValue(baseValue, keyFrameProgress);
			}
			if (this.IsCumulative)
			{
				...
				if (num4 > 0.0)
				{
					b = AnimatedTypeHelpers.AddByte(b, AnimatedTypeHelpers.ScaleByte(this.GetResolvedKeyFrameValue(num2), num4));
				}
			}
			if (this.IsAdditive)
			{
				return AnimatedTypeHelpers.AddByte(defaultOriginValue, b);
			}
			return b;
		}
		...
		// Token: 0x0600361A RID: 13850 RVA: 0x000D7DE4 File Offset: 0x000D71E4
		...
		// (get) Token: 0x0600361B RID: 13851 RVA: 0x000D7DFC File Offset: 0x000D71FC
		// (set) Token: 0x0600361C RID: 13852 RVA: 0x000D7E10 File Offset: 0x000D7210
		IList IKeyFrameAnimation.KeyFrames
		{
			...
			set
			{
				this.KeyFrames = (ByteKeyFrameCollection)value;
			}
		}

		/// <summary>Obtém ou define a coleção de objetos <see cref="T:System.Windows.Media.Animation.ByteKeyFrame" /> que definem a animação.</summary>
		/// <returns>A coleção de <see cref="T:System.Windows.Media.Animation.ByteKeyFrame" /> objetos que definem a animação. O valor padrão é <see cref="P:System.Windows.Media.Animation.ByteKeyFrameCollection.Empty" />.</returns>
		// Token: 0x17000AF7 RID: 2807
		// (get) Token: 0x0600361D RID: 13853 RVA: 0x000D7E2C File Offset: 0x000D722C
		// (set) Token: 0x0600361E RID: 13854 RVA: 0x000D7E88 File Offset: 0x000D7288
		public ByteKeyFrameCollection KeyFrames
		{
			get
			{
				...
				if (this._keyFrames == null)
				{
					if (base.IsFrozen)
					{
						this._keyFrames = ByteKeyFrameCollection.Empty;
					}
					else
					{
						base.WritePreamble();
						this._keyFrames = new ByteKeyFrameCollection();
						base.OnFreezablePropertyChanged(null, this._keyFrames);
						base.WritePostscript();
					}
				}
		...
		/// <summary>Retornará true se o valor da propriedade <see cref="P:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.KeyFrames" /> desta instância do <see cref="T:System.Windows.Media.Animation.ByteAnimationUsingKeyFrames" /> precisar ser serializado por valor.</summary>
		/// <returns>
		///   <see langword="true" /> se o valor da propriedade precisar ser serializado; caso contrário, <see langword="false" />.</returns>
		// Token: 0x0600361F RID: 13855 RVA: 0x000D7ECC File Offset: 0x000D72CC
		...
		// (get) Token: 0x06003620 RID: 13856 RVA: 0x000D7EF8 File Offset: 0x000D72F8
		// (set) Token: 0x06003621 RID: 13857 RVA: 0x000D7F18 File Offset: 0x000D7318
		...
		// (get) Token: 0x06003622 RID: 13858 RVA: 0x000D7F38 File Offset: 0x000D7338
		// (set) Token: 0x06003623 RID: 13859 RVA: 0x000D7F58 File Offset: 0x000D7358
		...
		// Token: 0x06003624 RID: 13860 RVA: 0x000D7F78 File Offset: 0x000D7378
		...
		// Token: 0x06003625 RID: 13861 RVA: 0x000D7F94 File Offset: 0x000D7394
		...
		// (get) Token: 0x06003626 RID: 13862 RVA: 0x000D7FC0 File Offset: 0x000D73C0
		...
		// Token: 0x06003627 RID: 13863 RVA: 0x000D8040 File Offset: 0x000D7440
		private void ResolveKeyTimes()
		{
			...
			while (i < num)
			{
				...
				case KeyTimeType.Paced:
					...
					else
					{
						...
						ByteAnimationUsingKeyFrames.KeyTimeBlock keyTimeBlock = default(ByteAnimationUsingKeyFrames.KeyTimeBlock);
			...
			{
				ByteAnimationUsingKeyFrames.KeyTimeBlock keyTimeBlock2 = (ByteAnimationUsingKeyFrames.KeyTimeBlock)arrayList[j];
				TimeSpan timeSpan = TimeSpan.Zero;
		...
		// Token: 0x06003628 RID: 13864 RVA: 0x000D8314 File Offset: 0x000D7714
		private void ResolvePacedKeyTimes()
		{
			...
			do
			{
				if (this._keyFrames[num].KeyTime.Type == KeyTimeType.Paced)
				{
					...
					double num4 = 0.0;
					byte from = this._keyFrames[num - 1].Value;
					do
					{
						byte value = this._keyFrames[num].Value;
						num4 += AnimatedTypeHelpers.GetSegmentLengthByte(from, value);
						list.Add(num4);
						from = value;
						num++;
					}
					while (num < num2 && this._keyFrames[num].KeyTime.Type == KeyTimeType.Paced);
					num4 += AnimatedTypeHelpers.GetSegmentLengthByte(from, this._keyFrames[num].Value);
