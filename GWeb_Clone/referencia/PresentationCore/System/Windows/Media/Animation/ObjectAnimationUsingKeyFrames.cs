...
{
	/// <summary>Anima o valor de uma propriedade <see cref="T:System.Object" /> junto com um conjunto de <see cref="P:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames.KeyFrames" /> em um <see cref="P:System.Windows.Media.Animation.Timeline.Duration" /> especificado.</summary>
	// Token: 0x02000523 RID: 1315
	[ContentProperty("KeyFrames")]
	public class ObjectAnimationUsingKeyFrames : ObjectAnimationBase, IKeyFrameAnimation, IAddChild
	{
		/// <summary>Inicializa uma nova instância da classe <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />.</summary>
		// Token: 0x06003B5F RID: 15199 RVA: 0x000E9240 File Offset: 0x000E8640
		public ObjectAnimationUsingKeyFrames()
		{
			this._areKeyTimesValid = true;
		}

		/// <summary>Cria um clone modificável desse <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />, fazendo cópias em profundidade dos valores do objeto. Ao copiar as propriedades de dependência, esse método copia associações de dados e referências de recurso (mas eles não podem mais resolver), mas não animações ou seus valores atuais.</summary>
		/// <returns>Um clone modificável do objeto atual. A propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> do objeto clonado será <see langword="false" />, mesmo se a propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> da origem tiver sido <see langword="true." /></returns>
		// Token: 0x06003B60 RID: 15200 RVA: 0x000E925C File Offset: 0x000E865C
		public new ObjectAnimationUsingKeyFrames Clone()
		{
			return (ObjectAnimationUsingKeyFrames)base.Clone();
		}

		/// <summary>Cria um clone modificável desse objeto <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />, fazendo cópias em profundidade dos valores do objeto atual. Referências a recursos, vinculações de dados e animações não são copiadas, mas seus valores atuais são.</summary>
		/// <returns>Um clone modificável do objeto atual. A propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> do objeto clonado será <see langword="false" />, mesmo se a propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> da origem tiver sido <see langword="true" />.</returns>
		// Token: 0x06003B61 RID: 15201 RVA: 0x000E9274 File Offset: 0x000E8674
		public new ObjectAnimationUsingKeyFrames CloneCurrentValue()
		{
			return (ObjectAnimationUsingKeyFrames)base.CloneCurrentValue();
		}

		/// <summary>Torna essa instância do objeto <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> somente leitura ou determina se ela pode ser tornada somente leitura.</summary>
		...
		// Token: 0x06003B62 RID: 15202 RVA: 0x000E928C File Offset: 0x000E868C
		...
		/// <summary>Chamado quando o objeto <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> atual é modificado.</summary>
		// Token: 0x06003B63 RID: 15203 RVA: 0x000E92C4 File Offset: 0x000E86C4
		...
		/// <summary>Cria uma nova instância de <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />.</summary>
		/// <returns>Uma nova instância de <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />.</returns>
		// Token: 0x06003B64 RID: 15204 RVA: 0x000E92E0 File Offset: 0x000E86E0
		protected override Freezable CreateInstanceCore()
		{
			return new ObjectAnimationUsingKeyFrames();
		}

		/// <summary>Torna essa instância uma cópia profunda do <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> especificado. Ao copiar as propriedades de dependência, esse método copia associações de dados e referências de recurso (mas eles não podem mais resolver), mas não animações ou seus valores atuais.</summary>
		/// <param name="sourceFreezable">O <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> a ser clonado.</param>
		// Token: 0x06003B65 RID: 15205 RVA: 0x000E92F4 File Offset: 0x000E86F4
		...
		/// <summary>Torna essa instância uma cópia profunda modificável do <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> especificado usando os valores de propriedade atuais. Referências a recursos, vinculações de dados e animações não são copiadas, mas seus valores atuais são.</summary>
		/// <param name="sourceFreezable">O <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> a ser clonado.</param>
		// Token: 0x06003B66 RID: 15206 RVA: 0x000E9318 File Offset: 0x000E8718
		...
		/// <summary>Torna essa instância um clone do objeto <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> especificado.</summary>
		/// <param name="source">O objeto <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> a ser clonado.</param>
		// Token: 0x06003B67 RID: 15207 RVA: 0x000E933C File Offset: 0x000E873C
		...
		/// <summary>Torna essa instância um clone congelado do <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> especificado. Referências a recursos, vinculações de dados e animações não são copiadas, mas seus valores atuais são.</summary>
		/// <param name="source">O <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> a ser copiado e congelado.</param>
		// Token: 0x06003B68 RID: 15208 RVA: 0x000E9360 File Offset: 0x000E8760
		...
		// Token: 0x06003B69 RID: 15209 RVA: 0x000E9384 File Offset: 0x000E8784
		private void CopyCommon(ObjectAnimationUsingKeyFrames sourceAnimation, bool isCurrentValueClone)
		{
			...
			if (sourceAnimation._keyFrames != null)
			{
				...
				{
					this._keyFrames = (ObjectKeyFrameCollection)sourceAnimation._keyFrames.CloneCurrentValue();
				}
				else
				{
		...
		// Token: 0x06003B6A RID: 15210 RVA: 0x000E9404 File Offset: 0x000E8804
		...
		/// <summary>Adiciona um <see cref="T:System.Windows.Media.Animation.ObjectKeyFrame" /> filho a este <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />.</summary>
		/// <param name="child">O objeto a ser adicionado como filho deste <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />.</param>
		/// <exception cref="T:System.ArgumentException">O parâmetro <paramref name="child" /> não é um <see cref="T:System.Windows.Media.Animation.ObjectKeyFrame" />.</exception>
		// Token: 0x06003B6B RID: 15211 RVA: 0x000E9434 File Offset: 0x000E8834
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		protected virtual void AddChild(object child)
		{
			ObjectKeyFrame objectKeyFrame = child as ObjectKeyFrame;
			if (objectKeyFrame != null)
			{
				this.KeyFrames.Add(objectKeyFrame);
				return;
			}
		...
		// Token: 0x06003B6C RID: 15212 RVA: 0x000E9470 File Offset: 0x000E8870
		...
		/// <summary>Adiciona uma cadeia de caracteres de texto como um filho deste <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />.</summary>
		/// <param name="childText">O texto adicionado ao <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />.</param>
		/// <exception cref="T:System.InvalidOperationException">Um <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> não aceita texto como um filho, portanto, esse método gerará esta exceção, a menos que uma classe derivada tenha substituído esse comportamento, o que permite que o texto seja adicionado.</exception>
		// Token: 0x06003B6D RID: 15213 RVA: 0x000E9494 File Offset: 0x000E8894
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		...
		/// <summary>Calcula um valor que representa o valor atual da propriedade que está sendo animada, conforme determinado por esta instância do <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" />.</summary>
		...
		// Token: 0x06003B6E RID: 15214 RVA: 0x000E94B0 File Offset: 0x000E88B0
		...
		// Token: 0x06003B6F RID: 15215 RVA: 0x000E9620 File Offset: 0x000E8A20
		...
		// (get) Token: 0x06003B70 RID: 15216 RVA: 0x000E9638 File Offset: 0x000E8A38
		// (set) Token: 0x06003B71 RID: 15217 RVA: 0x000E964C File Offset: 0x000E8A4C
		IList IKeyFrameAnimation.KeyFrames
		{
			...
			set
			{
				this.KeyFrames = (ObjectKeyFrameCollection)value;
			}
		}

		/// <summary>Obtém ou define a coleção de objetos <see cref="T:System.Windows.Media.Animation.ObjectKeyFrame" /> que definem a animação.</summary>
		/// <returns>A coleção de <see cref="T:System.Windows.Media.Animation.ObjectKeyFrame" /> objetos que definem a animação. O valor padrão é <see cref="P:System.Windows.Media.Animation.ObjectKeyFrameCollection.Empty" />.</returns>
		// Token: 0x17000BEC RID: 3052
		// (get) Token: 0x06003B72 RID: 15218 RVA: 0x000E9668 File Offset: 0x000E8A68
		// (set) Token: 0x06003B73 RID: 15219 RVA: 0x000E96C4 File Offset: 0x000E8AC4
		public ObjectKeyFrameCollection KeyFrames
		{
			get
			{
				...
				if (this._keyFrames == null)
				{
					if (base.IsFrozen)
					{
						this._keyFrames = ObjectKeyFrameCollection.Empty;
					}
					else
					{
						base.WritePreamble();
						this._keyFrames = new ObjectKeyFrameCollection();
						base.OnFreezablePropertyChanged(null, this._keyFrames);
						base.WritePostscript();
					}
				}
		...
		/// <summary>Retornará true se o valor da propriedade <see cref="P:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames.KeyFrames" /> desta instância do <see cref="T:System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames" /> precisar ser serializado por valor.</summary>
		/// <returns>
		///   <see langword="true" /> se o valor da propriedade precisar ser serializado; caso contrário, <see langword="false" />.</returns>
		// Token: 0x06003B74 RID: 15220 RVA: 0x000E9708 File Offset: 0x000E8B08
		...
		// Token: 0x06003B75 RID: 15221 RVA: 0x000E9734 File Offset: 0x000E8B34
		...
		// Token: 0x06003B76 RID: 15222 RVA: 0x000E9750 File Offset: 0x000E8B50
		...
		// (get) Token: 0x06003B77 RID: 15223 RVA: 0x000E977C File Offset: 0x000E8B7C
		...
		// Token: 0x06003B78 RID: 15224 RVA: 0x000E97FC File Offset: 0x000E8BFC
		private void ResolveKeyTimes()
		{
			...
			while (i < num)
			{
				...
				case KeyTimeType.Paced:
					...
					else
					{
						...
						ObjectAnimationUsingKeyFrames.KeyTimeBlock keyTimeBlock = default(ObjectAnimationUsingKeyFrames.KeyTimeBlock);
			...
			{
				ObjectAnimationUsingKeyFrames.KeyTimeBlock keyTimeBlock2 = (ObjectAnimationUsingKeyFrames.KeyTimeBlock)arrayList[j];
				TimeSpan timeSpan = TimeSpan.Zero;
		...
		// Token: 0x06003B79 RID: 15225 RVA: 0x000E9AD0 File Offset: 0x000E8ED0
		private void ResolvePacedKeyTimes()
		{
			...
			do
			{
				if (this._keyFrames[num].KeyTime.Type == KeyTimeType.Paced)
				{
					...
					double num4 = 0.0;
					object from = this._keyFrames[num - 1].Value;
					do
					{
						object value = this._keyFrames[num].Value;
						num4 += AnimatedTypeHelpers.GetSegmentLengthObject(from, value);
						list.Add(num4);
						from = value;
						num++;
					}
					while (num < num2 && this._keyFrames[num].KeyTime.Type == KeyTimeType.Paced);
					num4 += AnimatedTypeHelpers.GetSegmentLengthObject(from, this._keyFrames[num].Value);
