...
{
	/// <summary>Anima o valor de uma propriedade <see cref="T:System.Decimal" /> junto com um conjunto de <see cref="P:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames.KeyFrames" />.</summary>
	// Token: 0x020004C0 RID: 1216
	[ContentProperty("KeyFrames")]
	public class DecimalAnimationUsingKeyFrames : DecimalAnimationBase, IKeyFrameAnimation, IAddChild
	{
		/// <summary>Inicializa uma nova instância da classe <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />.</summary>
		// Token: 0x0600370B RID: 14091 RVA: 0x000DBDE8 File Offset: 0x000DB1E8
		public DecimalAnimationUsingKeyFrames()
		{
			this._areKeyTimesValid = true;
		}

		/// <summary>Cria um clone modificável desse <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />, fazendo cópias em profundidade dos valores do objeto. Ao copiar as propriedades de dependência, esse método copia associações de dados e referências de recurso (mas eles não podem mais resolver), mas não animações ou seus valores atuais.</summary>
		/// <returns>Um clone modificável do objeto atual. A propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> do objeto clonado será <see langword="false" />, mesmo se a propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> da origem tiver sido <see langword="true" />.</returns>
		// Token: 0x0600370C RID: 14092 RVA: 0x000DBE04 File Offset: 0x000DB204
		public new DecimalAnimationUsingKeyFrames Clone()
		{
			return (DecimalAnimationUsingKeyFrames)base.Clone();
		}

		/// <summary>Cria um clone modificável desse objeto <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />, fazendo cópias em profundidade dos valores do objeto atual. Referências a recursos, vinculações de dados e animações não são copiadas, mas seus valores atuais são.</summary>
		/// <returns>Um clone modificável do objeto atual. A propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> do objeto clonado será <see langword="false" />, mesmo se a propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> da origem tiver sido <see langword="true" />.</returns>
		// Token: 0x0600370D RID: 14093 RVA: 0x000DBE1C File Offset: 0x000DB21C
		public new DecimalAnimationUsingKeyFrames CloneCurrentValue()
		{
			return (DecimalAnimationUsingKeyFrames)base.CloneCurrentValue();
		}

		/// <summary>Faz com que esta instância do objeto <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> não modificável ou determina se ela pode se tornar não modificável.</summary>
		...
		// Token: 0x0600370E RID: 14094 RVA: 0x000DBE34 File Offset: 0x000DB234
		...
		/// <summary>Chamado quando o objeto <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> atual é modificado.</summary>
		// Token: 0x0600370F RID: 14095 RVA: 0x000DBE6C File Offset: 0x000DB26C
		...
		/// <summary>Cria uma nova instância de <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />.</summary>
		/// <returns>Uma nova instância de <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />.</returns>
		// Token: 0x06003710 RID: 14096 RVA: 0x000DBE88 File Offset: 0x000DB288
		protected override Freezable CreateInstanceCore()
		{
			return new DecimalAnimationUsingKeyFrames();
		}

		/// <summary>Torna essa instância uma cópia profunda do <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> especificado. Ao copiar as propriedades de dependência, esse método copia associações de dados e referências de recurso (mas eles não podem mais resolver), mas não animações ou seus valores atuais.</summary>
		/// <param name="sourceFreezable">O <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> a ser clonado.</param>
		// Token: 0x06003711 RID: 14097 RVA: 0x000DBE9C File Offset: 0x000DB29C
		...
		/// <summary>Torna essa instância uma cópia profunda modificável do <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> especificado usando os valores de propriedade atuais. Referências a recursos, vinculações de dados e animações não são copiadas, mas seus valores atuais são.</summary>
		/// <param name="sourceFreezable">O <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> a ser clonado.</param>
		// Token: 0x06003712 RID: 14098 RVA: 0x000DBEC0 File Offset: 0x000DB2C0
		...
		/// <summary>Torna essa instância um clone do objeto <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> especificado.</summary>
		/// <param name="source">O objeto <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> a ser clonado e congelado.</param>
		// Token: 0x06003713 RID: 14099 RVA: 0x000DBEE4 File Offset: 0x000DB2E4
		...
		/// <summary>Torna essa instância uma cópia do <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> especificado.</summary>
		/// <param name="source">O <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> a ser copiado e congelado</param>
		// Token: 0x06003714 RID: 14100 RVA: 0x000DBF08 File Offset: 0x000DB308
		...
		// Token: 0x06003715 RID: 14101 RVA: 0x000DBF2C File Offset: 0x000DB32C
		private void CopyCommon(DecimalAnimationUsingKeyFrames sourceAnimation, bool isCurrentValueClone)
		{
			...
			if (sourceAnimation._keyFrames != null)
			{
				...
				{
					this._keyFrames = (DecimalKeyFrameCollection)sourceAnimation._keyFrames.CloneCurrentValue();
				}
				else
				{
		...
		// Token: 0x06003716 RID: 14102 RVA: 0x000DBFAC File Offset: 0x000DB3AC
		...
		/// <summary>Adiciona um <see cref="T:System.Windows.Media.Animation.DecimalKeyFrame" /> filho a este <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />.</summary>
		/// <param name="child">O objeto a ser adicionado como filho deste <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />.</param>
		/// <exception cref="T:System.ArgumentException">O parâmetro <paramref name="child" /> não é um <see cref="T:System.Windows.Media.Animation.DecimalKeyFrame" />.</exception>
		// Token: 0x06003717 RID: 14103 RVA: 0x000DBFDC File Offset: 0x000DB3DC
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		protected virtual void AddChild(object child)
		{
			DecimalKeyFrame decimalKeyFrame = child as DecimalKeyFrame;
			if (decimalKeyFrame != null)
			{
				this.KeyFrames.Add(decimalKeyFrame);
				return;
			}
		...
		// Token: 0x06003718 RID: 14104 RVA: 0x000DC018 File Offset: 0x000DB418
		...
		/// <summary>Adiciona uma cadeia de caracteres de texto como um filho deste <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />.</summary>
		/// <param name="childText">O texto adicionado ao <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />.</param>
		/// <exception cref="T:System.InvalidOperationException">Um <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> não aceita texto como um filho, portanto, esse método gerará esta exceção, a menos que uma classe derivada tenha substituído esse comportamento, o que permite que o texto seja adicionado.</exception>
		// Token: 0x06003719 RID: 14105 RVA: 0x000DC03C File Offset: 0x000DB43C
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		...
		/// <summary>Calcula um valor que representa o valor atual da propriedade que está sendo animada, conforme determinado por esta instância do <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" />.</summary>
		...
		// Token: 0x0600371A RID: 14106 RVA: 0x000DC058 File Offset: 0x000DB458
		protected sealed override decimal GetCurrentValueCore(decimal defaultOriginValue, decimal defaultDestinationValue, AnimationClock animationClock)
		{
			...
			else
			{
				...
				if (i == 0)
				{
					if (this.IsAdditive)
					{
						baseValue = AnimatedTypeHelpers.GetZeroValueDecimal(defaultOriginValue);
					}
					else
					{
			...
			if (this.IsCumulative)
			{
				...
				if (num5 > 0.0)
				{
					num3 = AnimatedTypeHelpers.AddDecimal(num3, AnimatedTypeHelpers.ScaleDecimal(this.GetResolvedKeyFrameValue(num2), num5));
				}
			}
			if (this.IsAdditive)
			{
				return AnimatedTypeHelpers.AddDecimal(defaultOriginValue, num3);
			}
			return num3;
		}
		...
		// Token: 0x0600371B RID: 14107 RVA: 0x000DC24C File Offset: 0x000DB64C
		...
		// (get) Token: 0x0600371C RID: 14108 RVA: 0x000DC264 File Offset: 0x000DB664
		// (set) Token: 0x0600371D RID: 14109 RVA: 0x000DC278 File Offset: 0x000DB678
		IList IKeyFrameAnimation.KeyFrames
		{
			...
			set
			{
				this.KeyFrames = (DecimalKeyFrameCollection)value;
			}
		}

		/// <summary>Obtém ou define a coleção de objetos <see cref="T:System.Windows.Media.Animation.DecimalKeyFrame" /> que definem a animação.</summary>
		/// <returns>A coleção de <see cref="T:System.Windows.Media.Animation.DecimalKeyFrame" /> objetos que definem a animação. O valor padrão é <see cref="P:System.Windows.Media.Animation.DecimalKeyFrameCollection.Empty" />.</returns>
		// Token: 0x17000B2C RID: 2860
		// (get) Token: 0x0600371E RID: 14110 RVA: 0x000DC294 File Offset: 0x000DB694
		// (set) Token: 0x0600371F RID: 14111 RVA: 0x000DC2F0 File Offset: 0x000DB6F0
		public DecimalKeyFrameCollection KeyFrames
		{
			get
			{
				...
				if (this._keyFrames == null)
				{
					if (base.IsFrozen)
					{
						this._keyFrames = DecimalKeyFrameCollection.Empty;
					}
					else
					{
						base.WritePreamble();
						this._keyFrames = new DecimalKeyFrameCollection();
						base.OnFreezablePropertyChanged(null, this._keyFrames);
						base.WritePostscript();
					}
				}
		...
		/// <summary>Retornará true se o valor da propriedade <see cref="P:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames.KeyFrames" /> desta instância do <see cref="T:System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames" /> precisar ser serializado por valor.</summary>
		/// <returns>
		///   <see langword="true" /> se o valor da propriedade precisar ser serializado; caso contrário, <see langword="false" />.</returns>
		// Token: 0x06003720 RID: 14112 RVA: 0x000DC334 File Offset: 0x000DB734
		...
		// (get) Token: 0x06003721 RID: 14113 RVA: 0x000DC360 File Offset: 0x000DB760
		// (set) Token: 0x06003722 RID: 14114 RVA: 0x000DC380 File Offset: 0x000DB780
		...
		// (get) Token: 0x06003723 RID: 14115 RVA: 0x000DC3A0 File Offset: 0x000DB7A0
		// (set) Token: 0x06003724 RID: 14116 RVA: 0x000DC3C0 File Offset: 0x000DB7C0
		...
		// Token: 0x06003725 RID: 14117 RVA: 0x000DC3E0 File Offset: 0x000DB7E0
		...
		// Token: 0x06003726 RID: 14118 RVA: 0x000DC3FC File Offset: 0x000DB7FC
		...
		// (get) Token: 0x06003727 RID: 14119 RVA: 0x000DC428 File Offset: 0x000DB828
		...
		// Token: 0x06003728 RID: 14120 RVA: 0x000DC4A8 File Offset: 0x000DB8A8
		private void ResolveKeyTimes()
		{
			...
			while (i < num)
			{
				...
				case KeyTimeType.Paced:
					...
					else
					{
						...
						DecimalAnimationUsingKeyFrames.KeyTimeBlock keyTimeBlock = default(DecimalAnimationUsingKeyFrames.KeyTimeBlock);
			...
			{
				DecimalAnimationUsingKeyFrames.KeyTimeBlock keyTimeBlock2 = (DecimalAnimationUsingKeyFrames.KeyTimeBlock)arrayList[j];
				TimeSpan timeSpan = TimeSpan.Zero;
		...
		// Token: 0x06003729 RID: 14121 RVA: 0x000DC77C File Offset: 0x000DBB7C
		private void ResolvePacedKeyTimes()
		{
			...
			do
			{
				if (this._keyFrames[num].KeyTime.Type == KeyTimeType.Paced)
				{
					...
					double num4 = 0.0;
					decimal from = this._keyFrames[num - 1].Value;
					do
					{
						decimal value = this._keyFrames[num].Value;
						num4 += AnimatedTypeHelpers.GetSegmentLengthDecimal(from, value);
						list.Add(num4);
						from = value;
						num++;
					}
					while (num < num2 && this._keyFrames[num].KeyTime.Type == KeyTimeType.Paced);
					num4 += AnimatedTypeHelpers.GetSegmentLengthDecimal(from, this._keyFrames[num].Value);
