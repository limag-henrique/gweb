...
{
	/// <summary>Classe abstrata que, quando implementada, anima um valor de <see cref="T:System.Char" />.</summary>
	// Token: 0x020004B6 RID: 1206
	public abstract class CharAnimationBase : AnimationTimeline
	{
		/// <summary>Cria um clone modificável desse <see cref="T:System.Windows.Media.Animation.CharAnimationBase" />, fazendo cópias em profundidade dos valores do objeto. Ao copiar as propriedades de dependência, esse método copia associações de dados e referências de recurso (mas eles não podem mais resolver), mas não animações ou seus valores atuais.</summary>
		/// <returns>Um clone modificável do objeto atual. A propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> do objeto clonado será <see langword="false" />, mesmo se a propriedade <see cref="P:System.Windows.Freezable.IsFrozen" /> da origem tiver sido <see langword="true." /></returns>
		// Token: 0x0600364B RID: 13899 RVA: 0x000D8AE0 File Offset: 0x000D7EE0
		...
		// Token: 0x0600364C RID: 13900 RVA: 0x000D8AF8 File Offset: 0x000D7EF8
		public sealed override object GetCurrentValue(object defaultOriginValue, object defaultDestinationValue, AnimationClock animationClock)
		{
			...
			return this.GetCurrentValue((char)defaultOriginValue, (char)defaultDestinationValue, animationClock);
		}
		...
		// (get) Token: 0x0600364D RID: 13901 RVA: 0x000D8B3C File Offset: 0x000D7F3C
		...
		/// <param name="animationClock">O <see cref="T:System.Windows.Media.Animation.AnimationClock" /> que pode gerar o valor <see cref="P:System.Windows.Media.Animation.Clock.CurrentTime" /> ou <see cref="P:System.Windows.Media.Animation.Clock.CurrentProgress" /> a ser usado pela animação para gerar o valor de saída.</param>
		/// <returns>O valor que essa animação acredita que deve ser o valor atual da propriedade.</returns>
		// Token: 0x0600364E RID: 13902 RVA: 0x000D8B5C File Offset: 0x000D7F5C
