...
function evaluateDataflow() {
    ...
    for (var pass = 0; pass < 10; pass++) {
        ...
        allNodes.forEach(function (node) {
            ...
            var c = v.in2 !== null ? v.in2 : 0; // 3rd input support
...
var htmlGenerators = {
    ...
    'divider':     function () { return '<hr style="width:100%;border:1px solid #ccc;margin:10px 0;pointer-events:none;">'; },
